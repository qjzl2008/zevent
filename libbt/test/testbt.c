...
int main(void)
{
	...
	rv = bt_add_url("downloads","kongfu.torrent","http://172.16.118.42/kongfu.torrent",&bt_arg);
	if(rv == 1)
	{
	...
	rv = bt_add_p2sp("kongfu.torrent","http://172.16.118.42",&bt_arg);
