...
int bts_get(struct bt_stream *bts, fpos_t off, uint8_t *buf, size_t len);
int bts_put(struct bt_stream *bts, fpos_t off, const uint8_t *buf, size_t len);
int bts_sha(struct bt_stream *bts, fpos_t start, fpos_t length, uint8_t *hash);
int bts_seek(struct bt_stream *bts, fpos_t off);
