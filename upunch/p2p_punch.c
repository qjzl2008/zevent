...
/* ***************************************************** */
P2P_DECLARE(int) start_punching_daemon(punch_arg_t *args, p2p_edge_t *node,callback_t reg_cb)
{
	int i;
